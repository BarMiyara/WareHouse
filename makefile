...
# all: clean bin/Action.o bin/Volunteer.o bin/Order.o bin/WareHouse.o bin/main.o warehouse
...
link:
	g++ -o bin/warehouse bin/main.o bin/BaseAction.o bin/Customer.o bin/Order.o bin/Volunteer.o bin/WareHouse.o